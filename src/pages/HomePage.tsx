...
export function HomePage() {
  ...
  const scrollToDownload = useCallback(() => {
    ...
    window.setTimeout(() => urlInputRef.current?.focus(), 450)
  }, [])
  ...
  return (
    <main className="home-page">
      ...
      <RobotHero onDownloadClick={scrollToDownload} />

      <div id="download" className="home-schematic" aria-label="Download workspace">
          ...
          <div className="home-cell-inner">
            <div className="home-controls">
              ...
              {(isProcessing || error != null || shareLink !== '') && (
                <div className="home-feedback" aria-live="polite">
                  ...
                  {isProcessing && progress == null && (
                    <p className="home-progress">Starting download…</p>
                  )}
