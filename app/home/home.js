    ...
    function ($routeProvider) {
        $routeProvider
            .when('/home', {
                ...
                function($scope, $routeParams, $location, toastr, TheGitDownService) {
                    $scope.downUrl = "";
                    $scope.url = "";
                    ...
                    var downloadUrlPrefix = "https://minhaskamal.github.io/TheGitDown/"+downloadUrlInfix;
                    ...
                    if ($scope.url.match(templateUrl)) {
                        ...
                        TheGitDownService.downloadZippedFiles(parameter, progress, toastr);
